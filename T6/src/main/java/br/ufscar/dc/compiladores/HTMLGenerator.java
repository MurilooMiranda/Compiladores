...
public class Main {
    private static final java.util.List<String> errosSintaticos = new java.util.ArrayList<>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        lexer.addErrorListener(new BaseErrorListener() {
            ...
            public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol,
                ...
                String erro = "[LEXER] Erro na linha " + line + ":" + charPositionInLine + " - " + msg;
        ...
        parser.addErrorListener(new BaseErrorListener() {
            ...
            public void syntaxError(Recognizer<?, ?> recognizer, Object offendingSymbol,
                    int line, int charPositionInLine,
                    String msg, RecognitionException e) {
                String erro = "[PARSER] Erro na linha " + line + ":" + charPositionInLine + " - " + msg;
                System.err.println(erro);
                errosSintaticos.add(erro);
                hasErrors = true;
            }
        ...
        // Não interrompe aqui: deixa o código seguir para analisar semântica e gerar
        // arquivo
        ...
        if (!analyzer.getErros().isEmpty()) {
            ...
            System.err.println("Análise semântica falhou: erros semânticos encontrados.");
            System.exit(1);
        } else if (hasErrors) {
            // Se não tem erros semânticos mas tem erro léxico/sintático, avisa isso
            LogGenerator.gerarLog(errosSintaticos);
            System.err.println("Análise falhou: erros léxicos ou sintáticos encontrados.");
            System.exit(1);
        } else {
            // Nenhum erro
