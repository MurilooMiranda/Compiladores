...
public class T3SemanticoUtils {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.Exp_aritmeticaContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.TermoContext ctx) {
        // A variável que será retornada ao fim da execução é inicializada com o tipo
        // do primeiro elemento que será verificado, para fins de comparação.
        TipoT3 tipoRetorno = verificarTipo(tabela, ctx.fator().get(0));
                
        for (t3GramParser.FatorContext fatorArit : ctx.fator()) {
            // Esta outra variável recebe os tipos dos outros termos da expressão.
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.FatorContext ctx) {
        TipoT3 tipoRetorno = null;
        
        for (t3GramParser.ParcelaContext parcela : ctx.parcela())
            tipoRetorno = verificarTipo(tabela, parcela);

        return tipoRetorno;
    }

    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.ParcelaContext ctx) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.Parcela_unarioContext ctx) {
        TipoT3 tipoRetorno;
        String nome;
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.Parcela_nao_unarioContext ctx) {
        TipoT3 tipoRetorno;
        String nome;
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.ExpressaoContext ctx) {
        ...
        // são diferentes.
        for (t3GramParser.Termo_logicoContext termoLogico : ctx.termo_logico()) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.Termo_logicoContext ctx) {
        TipoT3 tipoRetorno = verificarTipo(tabela, ctx.fator_logico(0));

        // Para expressões lógicas, a ideia resume-se apenas em verificar se os tipos analisados
        // são diferentes.
        for (t3GramParser.Fator_logicoContext fatorLogico : ctx.fator_logico()) {
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.Fator_logicoContext ctx) {
        TipoT3 tipoRetorno = verificarTipo(tabela, ctx.parcela_logica());
        return tipoRetorno;

    }

    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.Parcela_logicaContext ctx) {
        TipoT3 tipoRetorno;
    ...
    public static TipoT3 verificarTipo(TabelaDeSimbolos tabela, t3GramParser.Exp_relacionalContext ctx) {
